...
public:
	ExampleLayer()
		: m_Camera(45.f, .1f, 100.f)
	{
		Material& pinkSphere = m_Scene.Materials.emplace_back();
		pinkSphere.Albedo = { 1.0f, 0.0f, 1.0f }; // Pink
		pinkSphere.Roughness = 0.0f;

		Material& blueSphere = m_Scene.Materials.emplace_back();
		blueSphere.Albedo = { 0.2f, 0.3f, 1.0f }; // Blue
	...
	virtual void OnUIRender() override // App Loop
	{
		...
		{
			ImGui::PushID(i); // This gives at this UI block a unique ID, to avoid conflicts
